...
class Elementor_blog_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__('Content', 'elementor-blog-widget'),
        ...
        $this->add_control(
            'logo',
            [
                'label' => esc_html__('Logo', 'elementor-blog-widget'),
                        ...
                        <div class="col-md-12">
                            <div class="post-blog">
                                <div class="blog-image">
                                    <img src="<?php bloginfo('template_directory'); ?>/green/images/includes/blog2.jpg" alt="">
                                </div> <!-- /.blog-image -->
                        ...
                        <div class="col-md-12">
                            <div id="blog-author" class="clearfix">
                                <a href="#" class="blog-author-img pull-left">
                                    <img src="<?php bloginfo('template_directory'); ?>/green/images/includes/author.png" alt="">
                                </a>
                            ...
                            <div id="blog-comments" class="blog-post-comments">
                                ...
                                <div class="blog-comments-content">
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="media-object"
                                                src="<?php bloginfo('template_directory'); ?>/green/images/includes/comment1.jpg"
                                                alt="">
                                        </div>
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="media-object"
                                                        src="<?php bloginfo('template_directory'); ?>/green/images/includes/comment2.jpg"
                                                        alt="">
                                                </div>
                                                <div class="media-body">
                                                    <div class="media-heading">
                                    ...
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="media-object"
                                                src="<?php bloginfo('template_directory'); ?>/green/images/includes/comment3.jpg"
                                                alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="media-heading">
