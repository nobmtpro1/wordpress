...
class Elementor_blogs_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__('Content', 'elementor-blogs-widget'),
        ...
        $this->add_control(
            'logo',
            [
                'label' => esc_html__('Logo', 'elementor-blogs-widget'),
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="post-blog">
                                <div class="blog-image">
                                    <a href="blog-single.html">
                                        <img src="<?php bloginfo('template_directory'); ?>/green/images/includes/blog1.jpg"
                                            alt="">
                                    </a>
                                </div> <!-- /.blog-image -->
                            ...
                            <div class="post-blog">
                                <div class="blog-image">
                                    <a href="blog-single.html">
                                        <img src="<?php bloginfo('template_directory'); ?>/green/images/includes/blog2.jpg"
                                            alt="">
                                    </a>
                                </div> <!-- /.blog-image -->
                                <div class="blog-content">
                            ...
                            <div class="post-blog">
                                <div class="blog-image">
                                    <a href="blog-single.html">
                                        <img src="<?php bloginfo('template_directory'); ?>/green/images/includes/blog3.jpg"
                                            alt="">
                                    </a>
                                </div> <!-- /.blog-image -->
                                <div class="blog-content">
                            ...
                            <div class="post-blog">
                                <div class="blog-image">
                                    <a href="blog-single.html">
                                        <img src="<?php bloginfo('template_directory'); ?>/green/images/includes/blog4.jpg"
                                            alt="">
                                    </a>
                                </div> <!-- /.blog-image -->
                                <div class="blog-content">
